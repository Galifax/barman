...
<div class="col-sm-9" style="margin-top: 15px;">
    <div class="row">
        ...
        <div class="cuadro_intro_hover " style="background-color:#cccccc;">
            ...
            <h2 class="border">Category order : *Category*</h2>

            <div class="border">
                <h2>Employer name</h2>
                <img style="max-height: 100px" src="https://t3.ftcdn.net/jpg/01/06/07/16/240_F_106071621_UwCztl7yyMbVNSMijfuYyZrzbtmoxJPH.jpg" alt="post img" class="pull-left img-responsive thumb margin10 img-thumbnail">
                <article>
                    <p>Work type</p>
                    <p>Duration of work</p>
                    <p>
                       Order discription | Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text
                        ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only
                        five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release
                        of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of
                        Lorem Ipsum.
                    </p></article>
                <a class="btn btn-blog pull-right marginBottom10" href="http://bootsnipp.com/user/snippets/2RoQ">Price 2000 $<br> Click to view details</a>
            </div>
...
<div class="col-sm-3" style="height: 100%">
    <div class="row" style=" margin:20px">
        <div class="col-sm-12">
            <h3 class="texe-tenter">Выберите категорию</h3>
            <ul class="filter-list">
                ...
                <li>
                    <button class="btn btn-default filter-button" data-filter="Data1">
                        Бар
                    </button>
                </li>
                <li>
                    <button class="btn btn-default filter-button" data-filter="Data2">
                        Ресторан
                    </button>
                </li>
                <li>
                    <button class="btn btn-default filter-button" data-filter="Data3">
                        Кафе
                    </button>
                </li>
            </ul>
            ...
            <h3 class="text-center">Other cities</h3>
            ...
            <hr>
                ...
                <h3 class="text-center">Tell About Us</h3>
                <p>We provide jobs to thousands of Ukrainians. Tell your friends about it and get a plus in your karma!</p>
